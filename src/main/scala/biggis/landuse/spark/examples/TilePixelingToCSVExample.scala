...
object TilePixelingToCSVExample extends LazyLogging {
  ...
  def apply(layerName: String, fileNameCSV: String)(implicit catalogPath: String, sc: SparkContext): Unit = {
    ...
    UtilsSVM.SaveAsCSVFileWithKey(samples, fileNameCSV)
